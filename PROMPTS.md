...
```
Read PROJECT_PLAN.md and PROMPTS.md in this workspace first. Work only in "/home/vk/Desktop/LLM_Chat_Interface" (uv-managed .venv, Python 3.11). Implement ONLY Step 1.
